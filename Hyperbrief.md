<!-- module: Hyperbrief; layer: decision-gating; part-of: EstreGenesis 2.5.x; version: v0.5.1; date: 2026-06-03; status: design draft v0.5.1 (clean-install ajv blocker fix per bundle 007 H1 — renderers/mini-engine.cjs + mcp/server.cjs ajv import switched from default draft-07 entrypoint to `ajv/dist/2020` draft-2020-12 dialect entrypoint; v0.4.0 determinism PASS smoke harness was run with `--skip-validate` and missed this; v0.5.1 cuts as a 2-line emergency-fix release ahead of bundle 007 absorption); depends-on: none (optional synergy: Constellation §13 A2A — active, Superscalar §3.1 decision-delegation interlock — active); license: Apache-2.0 -->
