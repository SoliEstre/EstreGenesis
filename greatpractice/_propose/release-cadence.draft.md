...
lifecycle: probation
last_referenced_turn: 2026-06-05T19:00:00Z
...
_propose_state:
  ...
  promotion_target: v2.5.5X or v2.6.0 (timing TBD, N>=2-3 post-codify data points recommended)
  ...
  post_codify_evidence:
    ...
    reduction_pct: 100
    validation_status: 'criterion §7.3 met for N=1; N>=2-3 recommended for high-confidence promotion'
  blocking_items_resolved:
    - 'hub release.md 9-item detail (RESOLVED v2.5.52 — hub-shared trigger/then schema integrated into §2)'
  blocking_items:
    ...
    - 'additional post-codify evidence (N>=2-3 release cycles maintaining 0 omissions for high-confidence promotion)'
    - 'user steering for ratification timing OR hub-side bidirectional cross-link trigger'
---
