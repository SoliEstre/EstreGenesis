...
<!-- seed-tier: Master; language: Korean; version: v1.5.0; date: 2026-05-07; counterpart: AI_Native_Project_Master_Seed_Prompt.md; changelog: README.md -->
...
**Empty-or-seed-only folder check**: 현재 작업 폴더가 비어 있거나, 이 seed prompt만 있거나, 아직 구체적 project work가 없다면 다음을 묻습니다.
