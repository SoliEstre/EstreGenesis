...
<!-- seed-tier: Master; language: Korean; version: v1.5.1; date: 2026-05-08; counterpart: AI_Native_Project_Master_Seed_Prompt.md; changelog: upstream EstreGenesis repository README.md, not target project README.md -->
...
사용자 답변을 받으면 이후 모든 대화는 **그 언어와 말투**로 진행. 문서·커밋 메시지는 선택 언어로 작성. 이 두 결정을 Phase 7에서 `AGENTS.md`에 기록.
