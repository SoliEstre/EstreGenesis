...
**Current**: v2.5.169 (2026-07-19) — **indicator-toggle micro placement (Constellation v2.4.65)** — the prompt-row toggle moves between attach and pause with a 🧵 prefix and 112px fixed width, browser-verified. verify-nway 20-axis PASS.
...
**현재**: v2.5.169 (2026-07-19) — **인디케이터 토글 미세 배치 (Constellation v2.4.65)** — 입력줄 토글을 첨부↔pause 사이로, 🧵 프리픽스 + 고정 폭 112px, 브라우저 실측. verify-nway 20축 PASS.
