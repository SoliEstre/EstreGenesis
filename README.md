...
<p align="center">
  <img alt="Version: v2.5.157" src="https://img.shields.io/badge/version-v2.5.157-2ea44f?style=for-the-badge" />
...
**현재**: v2.5.157 (2026-07-18) — **3번째 어댑터의 실명화: Estrelle 역링크** — 공개 비전이 EG 를 에이전트 하네스로 명시한 자가호스팅 개인 AI OS, [Estrelle](https://github.com/SoliEstre/Estrelle) 이 라이브됐어요; Harness Adapter Contract 의 계획된-3번째-어댑터 자리에 실명과 상호 진입점 링크를 반영. contract-first 의 이행이에요. verify-nway 19축 PASS.
