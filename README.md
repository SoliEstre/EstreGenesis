...
**Current**: v2.5.173 (2026-07-19) — **autocomplete token-based trigger (Constellation v2.4.69)** — the composer `/` autocomplete now opens mid-sentence after any space/newline and auto-closes on path-shaped tokens; apply replaces the token only. Playwright 8/8. verify-nway 20-axis PASS.
...
**현재**: v2.5.173 (2026-07-19) — **자동완성 토큰 기반 트리거 (Constellation v2.4.69)** — composer `/` 자동완성이 문장 중간 공백/줄바꿈 뒤에도 열리고 path 형태 토큰은 자동으로 닫혀요; 적용은 토큰만 치환해요. Playwright 8/8. verify-nway 20축 PASS.
