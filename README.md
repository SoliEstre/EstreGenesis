...
**Current**: v2.5.183 (2026-07-19) — **cumulative promo panel un-freeze (docs)** — the landing page's cumulative narrative re-curated from the v2.5.133 freeze to the current range (rooms, worker profile, adapter contract v0.2, gateway program, board-UX wave). verify-nway 20-axis PASS.
...
**현재**: v2.5.183 (2026-07-19) — **누적 성과 패널 해동결 (docs)** — 랜딩 페이지 누적 서사를 v2.5.133 동결에서 현행 범위(방·워커 프로필·어댑터 계약 v0.2·게이트웨이 프로그램·보드 UX 파동)로 재큐레이션했어요. verify-nway 20축 PASS.
