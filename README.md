...
**Current**: v2.5.178 (2026-07-19) — **setup-flow choice default (Hyperbrief v0.7.2 + kit v0.3.1, TC5)** — first-contact structured choices default to the plain floor band L1.1.1–L1.2.2 with costs/benefits, a recommendation and the explain-more-simply fallback (§5.6.9 + MUST-22); the kit setup skills wire it in. verify-nway 20-axis PASS.
...
**현재**: v2.5.178 (2026-07-19) — **세팅-흐름 선택지 기본값 (Hyperbrief v0.7.2 + 킷 v0.3.1, TC5)** — 첫-접촉 구조적 선택지는 평이 플로어 밴드 L1.1.1–L1.2.2 + 비용/편익·권고·"더 쉽게 설명해줘" 폴백이 기본이에요(§5.6.9 + MUST-22); 킷 세팅 스킬들이 배선됐어요. verify-nway 20축 PASS.
