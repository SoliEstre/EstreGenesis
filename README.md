...
**Current**: v2.5.170 (2026-07-19) — **monitor-window elevation shadow (Constellation v2.4.66)** — realtime-pane-grade shadow so the floating monitor separates from its surroundings. verify-nway 20-axis PASS.
...
**현재**: v2.5.170 (2026-07-19) — **모니터 창 승격 그림자 (Constellation v2.4.66)** — 실시간 창급 그림자로 플로팅 모니터가 주변과 분리돼 보여요. verify-nway 20축 PASS.
