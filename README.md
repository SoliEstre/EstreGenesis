...
<p align="center">
  <img alt="Version: v2.5.42" src="https://img.shields.io/badge/version-v2.5.42-2ea44f?style=for-the-badge" />
...
**Current**: v2.5.42 (2026-06-03) — README + marketplace.json catch-up: Hyperbrief module surfaced + Claude plugin marketplace install section added + all three plugins registered in [.claude-plugin/marketplace.json](.claude-plugin/marketplace.json). Seed-tier (Master + Lite + Compact × EN/KO) is at **v2.4.3** (2026-06-03). Most recent module cuts: Constellation v2.3.21, Superscalar v0.4.2, Hyperbrief v0.5.6.
...
**현재**: v2.5.42 (2026-06-03) — README + marketplace.json catch-up: Hyperbrief 모듈 surface + Claude 플러그인 마켓플레이스 설치 안내 섹션 추가 + 세 플러그인 모두 [.claude-plugin/marketplace.json](.claude-plugin/marketplace.json) 에 등록. 시드 tier (Master + Lite + Compact × EN/KO) 는 **v2.4.3** (2026-06-03). 최근 모듈 cut: Constellation v2.3.21, Superscalar v0.4.2, Hyperbrief v0.5.6.
