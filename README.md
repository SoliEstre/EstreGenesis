...
**Current**: v2.5.184 (2026-07-19) — **mirror-watcher operational contract (Constellation v2.4.73)** — the six watcher duties (single-instance, no restart replay, coalescing, echo-gating, identity fallback, snapshot cadence) spec'd; the contract, not the script, is portable. verify-nway 20-axis PASS.
...
**현재**: v2.5.184 (2026-07-19) — **미러-워처 운용 계약 (Constellation v2.4.73)** — 워처 의무 6항(단일 인스턴스·무리플레이·코얼레스·echo-게이팅·identity 폴백·스냅샷 cadence)을 스펙화했어요; 이식 대상은 계약이지 스크립트가 아니에요. verify-nway 20축 PASS.
