...
**Current**: v2.5.188 (2026-07-20) — **Asterism (Constellation v2.4.75)** — the A2A wire contract gets its name (⁂): Constellation is the deployment, Asterism is the pattern agents form on the wire — the harness-implementable surface. Wire unchanged; vocabulary cut. verify-nway 20-axis PASS.
...
**현재**: v2.5.188 (2026-07-20) — **Asterism (Constellation v2.4.75)** — A2A 와이어 계약의 정식 명명(⁂): Constellation 은 배포물, Asterism 은 에이전트들이 와이어에 이루는 패턴 — 하네스가 구현하는 표면이에요. 와이어 무변경·어휘 컷. verify-nway 20축 PASS.
