...
<p align="center">
  <img alt="Version: v2.5.108" src="https://img.shields.io/badge/version-v2.5.108-2ea44f?style=for-the-badge" />
...
각 플러그인 독립 — 하나, 둘, 셋, 넷, 또는 다섯 모두 설치 가능. 마켓플레이스 메타데이터는 [.claude-plugin/marketplace.json](.claude-plugin/marketplace.json), 각 플러그인 소스는 [plugins/](plugins/) 아래. Apache-2.0. Phase 2 production-ready (Constellation v0.3.16 + 5-tool MCP 서버; Superscalar v0.1.2 + §3.1 Hyperbrief interlock; Hyperbrief v0.7.0 + 3 skill + 4-tool MCP 서버 + PreToolUse/Stop hook; Greatpractice v0.3.1 + 3 JSON schema + 1 PreToolUse contact hook; Ultrasafe v0.2.2 + 8-agent red-team fan-out + clean-signal gate). Anthropic-side community-marketplace 등록은 [Hyperbrief.md §11.5](Hyperbrief.md) readiness rubric Lens B 에 따라 v1.0 GA 까지 defer.
