...
**Current**: v2.5.186 (2026-07-19) — **repo-wide redaction pass** — private-name scope ruling applied: two private project names replaced with role descriptions across living docs and historical records (20 substitutions, zero remaining); public umbrella-project mentions stay. verify-nway 20-axis PASS.
...
**현재**: v2.5.186 (2026-07-19) — **저장소 전체 redaction 패스** — 사설명 스코프 확정 적용: 비공개 프로젝트명 2종을 살아있는 문서·역사 기록 공통으로 역할 서술 치환(20치환·잔존 0); 공개 우산 프로젝트 언급은 유지예요. verify-nway 20축 PASS.
