...
**Current**: v2.5.181 (2026-07-19) — **compendium-lint self-count truth-up (Compendium v0.2.7)** — the skill now states the runtime's real split (four hard + three soft = seven checks) and maps it to §9's family grouping; three surfaces agree with no spec change. verify-nway 20-axis PASS.
...
**현재**: v2.5.181 (2026-07-19) — **compendium-lint 자기 카운트 정정 (Compendium v0.2.7)** — 스킬이 런타임 실제 분할(hard 4 + soft 3 = 7종)을 말하고 §9 가족 그룹핑과 매핑해요; 스펙 무변경으로 세 표면 합치. verify-nway 20축 PASS.
