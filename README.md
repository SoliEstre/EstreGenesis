...
**Current**: v2.5.174 (2026-07-19) — **HARNESS-ADAPTER-CONTRACT v0.2 (TC1)** — Hermes/OpenClaw candidate adapters with an 8-row research-verified surface map and a measurement gate (deferred rows promote only by recorded on-host triplets). verify-nway 20-axis PASS.
...
**현재**: v2.5.174 (2026-07-19) — **HARNESS-ADAPTER-CONTRACT v0.2 (TC1)** — Hermes/OpenClaw 후보 어댑터 + 8행 리서치 검증 표면 맵 + 실측 게이트(deferred 행은 실설치 3요소 기록으로만 승격)예요. verify-nway 20축 PASS.
