...
**Current**: v2.5.176 (2026-07-19) — **Constellation bootstrap guide (BOOTSTRAP.md v0.1, TC3)** — 8-chapter operational path for the hub-main + worker + dev-agent topology, with [gate] marks on candidate-host steps pending measurement. verify-nway 20-axis PASS.
...
**현재**: v2.5.176 (2026-07-19) — **Constellation 부트스트랩 가이드 (BOOTSTRAP.md v0.1, TC3)** — hub-main+워커+dev 에이전트 토폴로지의 8장 운용 경로예요; 후보 호스트 의존 단계는 실측 전까지 [gate] 마크. verify-nway 20축 PASS.
