...
**Current**: v2.5.177 (2026-07-19) — **eg-interview skill (kit v0.3.0, TC4)** — interview-strategy intake: press a vague or high-stakes request into a delegable brief before decomposing or delegating; alias /eggrill; docs roster un-staled to 36 skills. verify-nway 20-axis PASS.
...
**현재**: v2.5.177 (2026-07-19) — **eg-interview 스킬 (킷 v0.3.0, TC4)** — 인터뷰-전략 인테이크: 모호하거나 판 큰 요청을 분해·위임 전에 위임 가능한 브리프로 압착해요; 별칭 /eggrill; docs 로스터 36 스킬로 동결 해제. verify-nway 20축 PASS.
