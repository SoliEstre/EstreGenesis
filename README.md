...
**Current**: v2.5.185 (2026-07-19) — **Hermes surface map fully measured (adapter contract v0.3)** — all five deferred Hermes axes passed the §8.2 gate via remote measurement on a live instance; first cross-harness CommandManifest/OpsState declarations in the wild. verify-nway 20-axis PASS.
...
**현재**: v2.5.185 (2026-07-19) — **Hermes 표면 맵 전측정 (어댑터 계약 v0.3)** — 유보 5축 전부가 라이브 인스턴스 원격 실측으로 §8.2 게이트 통과; 야생의 첫 이종 하네스 CommandManifest/OpsState 선언이에요. verify-nway 20축 PASS.
