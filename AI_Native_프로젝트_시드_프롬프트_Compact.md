...
<!-- seed-tier: Compact; language: Korean; version: v2.5.0; date: 2026-06-11; counterpart: AI_Native_Project_Seed_Prompt_Compact.md; changelog: upstream EstreGenesis repository CHANGELOG.md, not target project README.md; v2.5.0 = 가지치기+레지스트리 cut — 운영 규율 §13.x 인라인 → Constellation.md SSoT 포인터화 (invariant 어휘 + 1줄 요지만 시드 유지) + provenance/verbatim redaction + § EG 모듈 레지스트리 (5종 1-테이블) 신설 -->
